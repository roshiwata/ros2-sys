...
#include "transport_robots/srv/detail/set_goal__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = transport_robots::srv::SetGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const transport_robots::srv::SetGoal_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<transport_robots::srv::SetGoal_Request *>(
    untyped_ros_message);
...
{
  return &transport_robots::srv::typesupport_fastrtps_cpp::_SetGoal_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = transport_robots::srv::SetGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const transport_robots::srv::SetGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<transport_robots::srv::SetGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &transport_robots::srv::typesupport_fastrtps_cpp::_SetGoal_Response__handle;
}
...
{
  return &transport_robots::srv::typesupport_fastrtps_cpp::_SetGoal__handle;
}
