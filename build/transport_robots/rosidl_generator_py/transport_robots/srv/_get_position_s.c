...
bool transport_robots__srv__get_position__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("transport_robots.srv._get_position.GetPosition_Request", full_classname_dest, 54) == 0);
  }
  transport_robots__srv__GetPosition_Request * ros_message = _ros_message;
  {  // robot_name
...
PyObject * transport_robots__srv__get_position__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("transport_robots.srv._get_position");
...
ROSIDL_GENERATOR_C_EXPORT
bool transport_robots__srv__get_position__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("transport_robots.srv._get_position.GetPosition_Response", full_classname_dest, 55) == 0);
  }
  transport_robots__srv__GetPosition_Response * ros_message = _ros_message;
  {  // success
