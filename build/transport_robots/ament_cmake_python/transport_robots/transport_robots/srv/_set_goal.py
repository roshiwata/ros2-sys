...
class Metaclass_SetGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('transport_robots')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'transport_robots.srv.SetGoal_Request')
            logger.debug(
...
class Metaclass_SetGoal_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'transport_robots.srv.SetGoal_Response')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_SetGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from transport_robots.srv import _set_goal
...
class SetGoal(metaclass=Metaclass_SetGoal):
    from transport_robots.srv._set_goal import SetGoal_Request as Request
    from transport_robots.srv._set_goal import SetGoal_Response as Response
