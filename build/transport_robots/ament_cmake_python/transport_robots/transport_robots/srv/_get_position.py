...
class Metaclass_GetPosition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'transport_robots.srv.GetPosition')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from transport_robots.srv import _get_position
...
class GetPosition(metaclass=Metaclass_GetPosition):
    from transport_robots.srv._get_position import GetPosition_Request as Request
    from transport_robots.srv._get_position import GetPosition_Response as Response
