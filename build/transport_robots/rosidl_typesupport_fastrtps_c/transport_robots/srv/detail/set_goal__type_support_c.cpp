...
#include "transport_robots/srv/detail/set_goal__rosidl_typesupport_fastrtps_c.h"
...
using _SetGoal_Request__ros_msg_type = transport_robots__srv__SetGoal_Request;
...
size_t get_serialized_size_transport_robots__srv__SetGoal_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetGoal_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_transport_robots__srv__SetGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_transport_robots
size_t max_serialized_size_transport_robots__srv__SetGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = transport_robots__srv__SetGoal_Request;
    is_plain =
      (
...
static size_t _SetGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_transport_robots__srv__SetGoal_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, transport_robots, srv, SetGoal_Request)() {
...
using _SetGoal_Response__ros_msg_type = transport_robots__srv__SetGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_transport_robots
size_t get_serialized_size_transport_robots__srv__SetGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetGoal_Response__ros_msg_type * ros_message = static_cast<const _SetGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_transport_robots__srv__SetGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_transport_robots
size_t max_serialized_size_transport_robots__srv__SetGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = transport_robots__srv__SetGoal_Response;
    is_plain =
      (
...
static size_t _SetGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_transport_robots__srv__SetGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, transport_robots, srv, SetGoal_Response)() {
...
// already included above
// #include "transport_robots/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "transport_robots/srv/set_goal.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, transport_robots, srv, SetGoal)() {
