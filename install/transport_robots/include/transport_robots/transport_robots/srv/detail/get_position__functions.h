...
#ifndef TRANSPORT_ROBOTS__SRV__DETAIL__GET_POSITION__FUNCTIONS_H_
#define TRANSPORT_ROBOTS__SRV__DETAIL__GET_POSITION__FUNCTIONS_H_
 ...
 * calls
 * transport_robots__srv__GetPosition_Request__init().
...
/**
 * It calls
 * transport_robots__srv__GetPosition_Request__fini()
 ...
 * transport_robots__srv__GetPosition_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * transport_robots__srv__GetPosition_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * transport_robots__srv__GetPosition_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_transport_robots
...
/**
 * It calls
 * transport_robots__srv__GetPosition_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_transport_robots
...
/**
 * It allocates the memory for the array and calls
 * transport_robots__srv__GetPosition_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_transport_robots
...
/**
 * It calls
 * transport_robots__srv__GetPosition_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TRANSPORT_ROBOTS__SRV__DETAIL__GET_POSITION__FUNCTIONS_H_
