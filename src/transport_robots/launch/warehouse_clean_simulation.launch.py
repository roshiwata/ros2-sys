...
def generate_launch_description():
    ...
    world_file = LaunchConfiguration('world_file', default=os.path.join(pkg_transport_robots, 'worlds', 'warehouse_clean.world'))
    ...
    declare_world_cmd = DeclareLaunchArgument(
        'world_file',
        default_value=os.path.join(pkg_transport_robots, 'worlds', 'warehouse_clean.world'),
